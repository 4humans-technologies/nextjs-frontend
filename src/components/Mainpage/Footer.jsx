  ...
  return (
    <div className="tw-mt-6">
      <div className="tw-grid tw-grid-cols-6 tw-auto-rows-auto tw-px-6 tw-py-6 tw-gap-x-3 tw-bg-first-color tw-tracking-wide">
        ...
        <div className="tw-col-span-1 flex tw-flex-col tw-content-start tw-justify-start tw-items-center">
      ...
      <div className="tw-bg-third-color tw-flex tw-items-center tw-justify-center tw-py-2 footer-top-shadow">
        <p className="tw-text-white-color tw-capitalize">By using this website, you agree to our cookie policy. we use cookies to deliver our services.</p>
      </div>
    </div>
  );
}
