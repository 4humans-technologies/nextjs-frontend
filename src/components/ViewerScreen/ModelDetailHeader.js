  ...
  return (
    <div className="tw-flex tw-justify-start tw-items-center tw-py-1.5 tw-px-4 tw-overflow-x-auto tw-flex-nowrap tw-bg-first-color tw-text-white-color tw-shadow-md tw-sticky">
      ...
      {isStreaming && (
        <a
          href="#model-profile-area"
          className="sm:tw-mr-4 tw-mr-2.5 sm:tw-text-base tw-text-sm tw-py-1 tw-rounded tw-font-semibold tw-text-green-color hover:tw-text-green-color"
        >
          Live
        </a>
      )}
      {onCall && !isStreaming && (
        <a
          href="#model-profile-area"
          className="sm:tw-mr-4 tw-mr-2.5 sm:tw-text-base tw-text-sm tw-py-1 tw-rounded tw-font-semibold tw-text-purple-600 hover:tw-text-purple-600"
        >
          On Call
        </a>
      )}
      ...
      <a
        href="#model-profile-area"
        className="sm:tw-mr-4 tw-mr-2.5 sm:tw-text-base tw-text-sm tw-capitalize tw-cursor-pointer hover:tw-text-white-color"
      >
        {username}
      </a>
      <a
