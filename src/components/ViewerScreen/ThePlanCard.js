function ThePlanCard(props) {
  return (
    <div className="tw-bg-second-color tw-rounded tw-text-center tw-py-3 tw-px-8 md:tw-px-10 lg:tw-px-14 xl:tw-px-16 tw-mx-3 tw-flex-grow-0 tw-flex-shrink-0 tw-text-text-black">
