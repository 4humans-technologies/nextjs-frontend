    ...
    fetch("/api/website/login", {
      ...
      .then((data) => {
        ...
        if (data.actionStatus === "success") {
          ...
          localStorage.setItem("jwtExpiresIn", Date.now() + data.expiresIn * 60 * 60 * 1000);
      ...
      <div className="tw-flex-shrink-0 tw-flex-grow-0">
        <div className="tw-grid tw-grid-cols-2 tw-grid-rows-1 tw-w-full tw-h-full">
          <div className="tw-relative tw-z-0 tw-col-span-1 tw-row-span-1 tw-text-center red-gray-gradient tw-pl-14 tw-pr-14 tw-pt-20 tw-pb-20 tw-rounded-md">
            <h1 className="tw-text-3xl tw-font-medium tw-text-white-color tw-mb-4 tw-text-center tw-ml-3 tw-z-20"> Login</h1>
          ...
          <div className="tw-col-span-1 tw-row-span-1 tw-relative">
            <div className="tw-absolute tw-top-0 tw-left-0 tw-right-0 tw-bottom-0 tw-flex tw-flex-col tw-items-start tw-align-bottom tw-content-end tw-px-4 tw-py-10 login-bg tw-bg-cover tw-bg-left-top" style={{ backgroundImage: `url(${loginBg.src})` }}>
              ...
              <div className="tw-flex-shrink tw-flex-grow-0">
                <div className="tw-flex tw-items-center tw-mt-2">
                  ...
                  <p className="tw-text-white-color tw-font-semibold tw-capitalize tw-pl-2">200M+ users worldwide</p>
                </div>
                <div className="tw-flex tw-items-center tw-mt-2">
                  <Money className="tw-text-white-color" />
                  <p className="tw-text-white-color tw-font-semibold tw-capitalize tw-pl-2">earn 24K+ per month</p>
                </div>
              </div>
            </div>
          </div>
