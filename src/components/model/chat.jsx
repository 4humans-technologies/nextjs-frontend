  ...
  return (
    <div className="tw-bg-black  tw-h-[100vh] tw-text-white tw-text-center ">
      ...
      <form
        action=""
        method="post"
        className="md:tw-w-1/2 md:tw-ml-[28%] tw-bg-red-400 tw-self-center "
      >
        <div className="tw-grid md:tw-grid-cols-12 tw-grid-cols-1  ">
          <div className="file-input md:tw-col-span-4 tw-text-center tw-bg-gray-400 tw-self-center  tw-w-full">
            <input
              type="file"
              name="file-input"
              id="file-input"
